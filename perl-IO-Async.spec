...
%prep
%setup -q -n IO-Async-0.802
cd %{_builddir}
tar xf %{_sourcedir}/libio-async-perl_0.72-1.debian.tar.xz
cd %{_builddir}/IO-Async-0.802
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/IO-Async-0.802/deblicense/
...
cp %{_builddir}/IO-Async-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-IO-Async/1a0db8ae53618717535b6c54006100fc3e919f87
...
/usr/share/package-licenses/perl-IO-Async/1a0db8ae53618717535b6c54006100fc3e919f87

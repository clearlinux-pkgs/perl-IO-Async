...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/IO-Async-0.77.tar.gz
...
%prep
%setup -q -n IO-Async-0.77
cd %{_builddir}
tar xf %{_sourcedir}/libio-async-perl_0.72-1.debian.tar.xz
cd %{_builddir}/IO-Async-0.77
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/IO-Async-0.77/deblicense/
...
cp %{_builddir}/IO-Async-0.77/LICENSE %{buildroot}/usr/share/package-licenses/perl-IO-Async/7e88e362b09da4b18d7e611c14945b5734383496

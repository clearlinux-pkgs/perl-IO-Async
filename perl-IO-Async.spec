...
%prep
%setup -q -n IO-Async-0.78
cd %{_builddir}
tar xf %{_sourcedir}/libio-async-perl_0.72-1.debian.tar.xz
cd %{_builddir}/IO-Async-0.78
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/IO-Async-0.78/deblicense/
...
cp %{_builddir}/IO-Async-0.78/LICENSE %{buildroot}/usr/share/package-licenses/perl-IO-Async/67825508da0c86b98557cec241ae7036d3165a11

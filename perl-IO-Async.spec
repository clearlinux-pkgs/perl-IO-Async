...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/IO-Async-0.73.tar.gz
...
%prep
%setup -q -n IO-Async-0.73
cd ..
%setup -q -T -D -n IO-Async-0.73 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/IO-Async-0.73/deblicense/
